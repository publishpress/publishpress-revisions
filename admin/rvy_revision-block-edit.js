...
if(rvyObjEdit.disableSubmitUntilSave){var intSaveWatch;setTimeout(function(){$(document).on('click','div.postbox-container,div.acf-postbox,.editor-post-schedule__dialog-toggle',function(){rvyDisableSubmitApprove();});},200);}
