...
* Fixed :] Database error on Revision approval - Unknown column 'filter' in 'field list' for query UPDATE `wp_posts` SET `post_autho,r`
...
* Fixed :] Did not observe capability definitions for custom post types (assumed capability_type ,[post_typ
